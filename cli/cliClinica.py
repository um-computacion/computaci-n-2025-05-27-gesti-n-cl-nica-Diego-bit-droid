...
from clinica.Turnosclinica import (Paciente, Medico, Clinica, Especialidad)
from clinica.excepciones import (ErrorAlAgregarMedico, ErrorAlAgregarPaciente, ErrorGeneralTurno, PacienteNoEncontradoExcepcion, MedicoNoDisponibleExcepcion, TurnoOcupadoException, ErrorPaciente, ErrorMedico, RecetaInvalidaException, EspecialidadYaExistente)
