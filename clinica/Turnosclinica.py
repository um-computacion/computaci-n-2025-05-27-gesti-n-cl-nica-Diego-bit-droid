...
from clinica.excepciones import EspecialidadYaExistente, ErrorPaciente, ErrorMedico, RecetaInvalidaException, PacienteNoEncontradoExcepcion, MedicoNoDisponibleExcepcion, TurnoOcupadoException, ErrorGeneralTurno
