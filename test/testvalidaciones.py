...
from validaciones import validar_existencia_paciente, validar_existencia_medico, validar_turno_no_duplicado, obtener_dia_semana_en_espanol, validar_especialidad_en_dia
from excepciones import TurnoOcupadoException, MedicoNoDisponibleExcepcion, ErrorPaciente, ErrorMedico
from Turnosclinica import Medico, Turno, Paciente, Especialidad
